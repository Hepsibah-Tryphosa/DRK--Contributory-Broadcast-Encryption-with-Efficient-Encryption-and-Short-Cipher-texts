...
public class EndUser implements ActionListener 
{
	...
	{
		jf = new JFrame("End User::Contributory Broadcast Encryption with Efficient Encryption and Short Cipher texts");
		c = jf.getContentPane();
		c.setLayout(null);
		...
		trust = new MenuItem("Search Other Group Files");
	...
	public void actionPerformed(ActionEvent e1)
	{
		...
		if(o==item2)
		{
			try
			{
				...
				String ip = JOptionPane.showInputDialog(null, "Enter The IP Address of Group Authority");

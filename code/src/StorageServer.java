...
public class StorageServer implements ActionListener {
	...
	StorageServer() {
		jf = new JFrame("Storage Server :: Contributory Broadcast Encryption with Efficient Encryption and Short Cipher texts");
		c = jf.getContentPane();
		c.setLayout(null);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (o == kdc) {
			...
			try
			{
				...
				GivePrivilages v = new GivePrivilages();
				v.setSize(350,350);
				v.setVisible(true);
					...
					while (true) 
					{
						...
						if(group.equalsIgnoreCase("GROUP1"))
						{
							String[] dsname = {"GROUP2","GROUP3"};
							 ...
							 String dataname = (String) JOptionPane.showInputDialog(null,"Select GROUP", "Group",
